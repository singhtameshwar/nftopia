import { UserPlus, Grid, Wallet, DollarSign, FolderKanban, Bell } from 'lucide-react';
        ...
        <div className="mb-16">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            ...
            <p className="text-gray-400 max-w-xl lg:text-right">
              Welcome to NFTopia! We`&lsquo;`ve designed this comprehensive guide to
              help you navigate your way from start to success.
            </p>
          </div>
        </div>
