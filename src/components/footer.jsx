...
export const FOOTER = () => {
  ...
  return (
    <footer className="bg-[#0F0F1A] text-white py-16 px-12">
      <div
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <button className="fixed bottom-8 right-8 w-11 h-11 rounded-full flex items-center justify-center bg-transparent border border-purple-500/50">
