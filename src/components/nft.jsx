  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-purple-900 p-4 sm:p-8 text-white">
      ...
      <div className="inline-flex items-center gap-2 mb-4 bg-[#1E1B2E] px-3 py-1.5 rounded-full">
        ...
        <p className="text-lg sm:text-xl text-gray-300">You Can `&lsquo;` t Miss.</p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {nftData.map((nft) => (
          ...
          >
            <div className="absolute top-4 left-4 bg-black/30 backdrop-blur-sm rounded-full px-3 py-1 flex items-center gap-1 text-white text-sm">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-[#1E1B2E]/90 backdrop-blur-lg p-4">
      ...
      <div className="flex justify-center mt-8">
        <button className="px-6 sm:px-8 py-3 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 hover:opacity-90 transition-opacity">
          Explore More
        </button>
      </div>
    </div>
